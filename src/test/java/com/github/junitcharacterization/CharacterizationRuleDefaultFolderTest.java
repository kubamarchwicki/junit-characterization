...
public class CharacterizationRuleDefaultFolderTest {
    ...
    final static String FILENAME = "com.github.junitcharacterization.CharacterizationRuleDefaultFolderTest.BusinessClassTest.txt";
    ...
    public static class BusinessClassTest {
        ...
        public void just_run_the_method() {
            service.businessMethod(CharacterizationRuleDefaultFolderTest.TEST_METHOD_PARAM);
